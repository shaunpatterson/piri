...
from piri3.casting import get_casting_function
from piri3.constants import (  # noqa: WPS235
    CONDITION,
    CONTAINS,
    DEFAULT_GROUP,
    FROM,
...
from piri3.valuetypes import MapValue, NewValue, ValueTypes
...
def apply_regexp(  # noqa: WPS212, WPS234
    ...
    Example
        >>> from piri3.functions import apply_regexp
